...
const FAQ = [
  {
    q: "What is GrowthOS?",
    a: "GrowthOS helps teams improve SEO, AEO, and GEO (AI-visibility) by scanning a site, proposing safe fixes, and deploying with verification and rollback where supported.",
  },
  {
